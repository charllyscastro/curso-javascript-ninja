(function () {
  ...
  */
  ...
  console.log(text.replace(/Manuel Marques de Sousa/, 'Charllys castro'));
  ...
  */
  ...
  console.log(text.replace(/A|a/g, 4)); //[Aa], /a/gi
  ...
  */
  ...
  var regexData = /(\d\d) de (junho|julho) de (\d\d\d\d)/g;
  ...
  */
  ...
  console.log(text.replace(regexData, replaceDate));
