...
*/
var championship = 'copaDoNordeste';
...
*/
// ?
var teams = ['ceara', 'fortaleza', 'ferroviario', 'caucaia', 'tiradentes'];
...
*/
function showTeamPosition(value){
  var novoValue = value - 1;
  var time =  'O time que está em ' + (value) + 'º lugar é o ' + teams[novoValue] + '.';
  var naoTime = 'Não temos a informação do time que está nessa posição.'
  return value <= teams.length && value > 0 ? time : naoTime;
};
