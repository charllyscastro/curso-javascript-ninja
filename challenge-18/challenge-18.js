(function () {
  ...
  */
  ...
  var expressReg = /\w{3}ho/g; // /ju[nl]ho/
  var text =' Os meses de janeiro, junho e julho começam com a letra j.';
  console.log(text.match(expressReg));
  ...
  */
  ...
  var newText = '<div><section><blockquote>Texto <img /></blockquote></section></div>';
  console.log(newText.match(/<\w+>/g))
  ...
  */
  ...
  var newText2 = '<div><ul><li></li><li></li><li><span></span></li></ul></div>';
  console.log(newText2.match(/<\w+><\/\w+>/g));
