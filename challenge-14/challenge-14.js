...
*/
console.log( '\nJust Numbers:' );
var justNumbers = numberObjects.map(function(item, indice, array){
  return  item.number;
});
...
var name = ['cas','tro','mar','ques'];
var newName = name.reduce(function(acumulado, atual, index, array){
...
console.log('a resposta é false, pois {number: 2} é referenciada a outra posição na memoria.');
